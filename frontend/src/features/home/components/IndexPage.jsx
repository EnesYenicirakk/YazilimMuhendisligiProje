import { merkezMenusu, merkezMenuPozisyonlari } from '../../../shared/utils/constantsAndHelpers'
...
export default function IndexPage({
  ...
  return (
    <>
      <section
        className={`merkez-ekrani ${gecisBalonu ? 'gecis-aktif' : ''} ${merkezGirisEfekti ? 'geri-giris' : ''}`}
          ...
          {merkezMenusu.map((kart, index) => {
            ...
            return (
              <button
                ...
                className={`merkez-balon renk-${kart.renk} ${gecisBalonu === kart.sayfa ? 'giriliyor' : ''}`}
                style={{
                  '--menu-x': pozisyon.x,
                  '--menu-y': pozisyon.y,
                }}
