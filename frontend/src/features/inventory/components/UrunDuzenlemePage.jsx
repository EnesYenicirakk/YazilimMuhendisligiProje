...
import { favorileriOneTasi, bosUrunDuzenlemeFormu, negatifSayiVarMi } from '../../../shared/utils/constantsAndHelpers';
const SAYFA_BASINA_URUN = 8;
const STOK_LOG_SAYFA_BASINA = 5;
import { kritikStoktaMi, paraFormatla } from '../../../shared/utils/constantsAndHelpers';

export default function UrunDuzenlemePage({
  KucukIkon, BosDurumKarti, MobilKart, urunler, setUrunler, toastGoster, favoriDegistir, stokDegisimLoglari
}) {
